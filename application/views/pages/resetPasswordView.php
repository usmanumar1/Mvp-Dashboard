                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <?php echo form_open('Doctor/reset_password', 'class="form-signin" id="myform"'); ?>
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" id="admin_name" name ="password1" class="form-control" placeholder="New Password" />
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="password" id="password" name = "password2" class="form-control" placeholder="Re-Type Password" />
