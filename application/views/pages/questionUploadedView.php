                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div style=" background: red; /* For browsers that do not support gradients */
                            ...
                            <table id="report" class="table table-bordered table-hover width-95" style="margin: auto; background-color:#ccffff;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 35%;">
                                            ...
                                            <div style="margin-left:80px; margin-right: 10px; float: left;">
                                        ...
                                        <th style="width: 15%;">
                                            <div style=" margin-right:10px; text-align: center; float: left;">
                                ...
                                <tbody>
                                    ...
                                    if ($questions) {
                                        ...
                                        foreach ($questions as $question) {
                                            ...
                                            <tr>
                                                <td style="width: 35%;"><div class="row"><div class="col-md-1" style="margin-left: 10px;"><?php echo $question->question_id; ?></div>
                                                        <div class="col-md-10">
                                                            <b> Q </b><br>
                                                            ...
                                                            <b> A </b>
                                                            <?php
                                                            if ($question->approve_status == 1 && $question->answer_status == 1 && $question->doc_answer_status == 1  ) {
                                                                ?>
                                                                <audio controls>
                                                    ...
                                                    <td>
                                                        <?php
                                                        foreach ($uploadedTime as $time_uploaded) {
                                                            if ($time_uploaded->question_id == $question->question_id) {
                                                                $dateupload = date_create($time_uploaded->time_approved);
                                                                echo (date_format($dateupload, 'd/m/y'));
                                                            }
                                                        }
                                                        ?>
                                                    ...
                                                    <td><div class="row">
                                                            <div class="col-md-5">
                                                                ...
                                                                foreach ($uploadedTime as $time_uploaded) {
                                                                    if ($time_uploaded->question_id == $question->question_id) {
                                                                        $dateupload = new DateTime($time_uploaded->time_approved);
                                                                        $dateapproved = new DateTime($time_uploaded->time_answered);
                                                                        $diff = $dateapproved->diff($dateupload);
                                                            ...
                                                            <div> <button type="button" class=" popover  btn btn-danger" 
                                                                          ...
                                                                          data-trigger=""  data-content="User ID: <?php echo($question->user_id); ?><br> Call ID: <?= $question->call_id; ?> <br>
                                                                          Date recorded:<?= date_format($dateRec, 'd/m/y'); ?><br>
