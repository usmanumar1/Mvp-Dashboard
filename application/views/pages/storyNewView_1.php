                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="dropdown" style="margin-top: -20px;">
                                                    <button class="btn btn-primary dropdown-toggle" type="button" id="<?php echo "btnStatus" . $story->user_story_id; ?>" data-toggle="dropdown">
                                                        ...
                                                        } elseif ($story->disapproved_reason == "HangUp") {
                                                            echo '<option value="Inaudible">HangUp</option>';
                                                        } elseif ($story->disapproved_reason == "Silent") {
                                                            echo '<option value="Inaudible">Silent</option>';
                                                        } elseif ($story->disapproved_reason == "Misplaced") {
                                                            echo '<option value="Inaudible">Misplaced</option>';
                                                        } else {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <br><select id="<?php echo "story_disapproval" . $story->user_story_id; ?>" >
                                                        <?php
                                                        if ($story->disapproved_reason == "Inappropriate") {
                                                            echo '<option value="Inappropriate">Inappropriate</option>';
                                                        } elseif ($story->disapproved_reason == "Irrelevant") {
...
<script type="text/javascript">
    ...
    function handleSendClick(button)
    {
       ...
       // alert('story_id=' + story_id + '&story_status=' + story_status + '&story_disapproval=' + story_disapproval + '&tag=' + tag + '&admin_id=' + admin_id);
