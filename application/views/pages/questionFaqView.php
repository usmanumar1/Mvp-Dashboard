                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div style=" background: red; /* For browsers that do not support gradients */
                            ...
                            <table id="report" class="table table-bordered table-hover width-85" style="margin: auto; background-color:#ccffff;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th >
                                            <div style=" margin-right: 10px; float: left;">
                                                <i class=" margin-10 ace-icon fa fa-list-ol bigger-120"></i>
                                            </div>                                            FAQ #:
                                        ...
                                        <th >
                                            <div style=" margin-right: 10px; float: left;">
                                                <i class=" margin-10 ace-icon fa fa-list-ol bigger-120"></i>
                                            </div>  # of times this<br> FAQ has been assigned
                                    ...
                                    if ($questions) {
                                        ...
                                        foreach ($questions as $question) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $question->faq; ?></td>
                                                <td>

                                                    <?php
                                                    foreach ($totalFaqAssigned as $total) {
                                                        if ($total->faq === $question->faq) {
                                                            echo($total->faqCount);
                                                        }
                                                    }
                                                    ?>
                                                ...
                                                <td><div class="row">
                                                        ...
                                                        <div> <button type="button" class=" popover  btn btn-danger" 
                                                                                       ...
                                                                                       <br>Date recorded:<?= date_format($dateAsk, 'd/m/y'); ?><br>
                                                                                       Time recorded:<?= date_format($dateAsk, 'g:i A'); ?>" data-html="true">
